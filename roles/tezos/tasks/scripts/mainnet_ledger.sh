...
services:
  ...
  node:
    ...
    command: tezos-node --allow-all-rpc node:8732 --rpc-addr node:8732 --private-mode --no-bootstrap-peers --connections=8 --bootstrap-threshold=1 --peer=dubnodes.tzbeta.net:9732 --peer=franodes.tzbeta.net:9732 --peer=sinnodes.tzbeta.net:9732 --peer=nrtnodes.tzbeta.net:9732 --peer=pdxnodes.tzbeta.net:9732 --net-addr :$port $@
    ports:
